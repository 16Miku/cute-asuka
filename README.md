...
### v1.5 (2026-07-17) ⭐当前版本
- 🏛 **全站沉浸体验**
  - `PageShell` 统一子页极光环境与滚动进度
  - Gallery：搜索、分类计数、卡片动效、Lightbox 键盘切换
  - Daily / About / 详情 / 留言板：玻璃拟态信息展陈
- 🌌 **v1.4 首页单页**
  - WebGL2 樱色极光、视差 Hero、胶片轨、Bento 入口
  - `color-mix` 主题令牌 + 明朝 display 栈 / Geist
...
- 🗑 **仓库清理**：添加 `dist/dev/` 到 `.gitignore`，避免开发缓存提交
